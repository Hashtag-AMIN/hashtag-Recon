...
echo "Query: $1 on $2 Search engine $3 pages:" > $now_date-$2-dorker.txt
go-dork --query "$1" --engine $2 --page $3 --silent >> $now_date-$2-dorker.txt

echo "go-dork Done, result & length ==> ` wc -l $now_date-$2-dorker.txt `"