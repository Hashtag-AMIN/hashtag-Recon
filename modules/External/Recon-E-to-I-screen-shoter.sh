...
httpx -list $1 -status-code -screenshot -follow-redirects -threads 25 -rate-limit 5 -silent -filter-code 404 -random-agent -no-color -store-response-dir $file_name-shot -output $file_name-shot.txt
